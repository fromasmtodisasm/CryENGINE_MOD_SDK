...
extern void getBBoxSSE (const Matrix44* pBones, unsigned numBones, CryBBox* pBBox);
extern void getBBoxSSE (const Matrix44* pBones, const CryBBoxA16* pBoneBBox, unsigned numBones, CryBBox* pBBox);
#endif
